...
if __name__ == '__main__':
    ...
    with open('/Users/sunny/Dropbox/Research/ML for Systems and Data Structures/repos/DeepBloom/data/dataset.json', 'r') as f:
        dataset = json.load(f)
    ...
    model = GRUModel(
        '/Users/sunny/Dropbox/Research/ML for Systems and Data Structures/repos/DeepBloom/data/glove.6B.50d-char.txt', embedding_dim, char_indices, indices_char)
    model.to(device)
